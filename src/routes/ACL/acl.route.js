...
router.get('/permissions', authenticateToken, aclController.getPermissions);
...
router.get('/user-permissions/:empid', authenticateToken, aclController.getUserPermissions);
